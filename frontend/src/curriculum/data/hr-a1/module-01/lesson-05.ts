  ...
  content: {
    ...
    "steps": [
      ...
      },
      {
        ...
        "correctIndex": 2,
        "targetText": "prompt",
        "promptAudioSrc": "/audio/hr/a1/module-01/dva.mp3"
      },
      {
        "id": "vocab",
        "stage": "words",
      ...
      },
      {
        ...
        "stage": "structure",
        "type": "structure",
        "title": "Gdy czegoś nie rozumiesz",
        "explanation": "Te zdania przydadzą się w każdej rozmowie. Ne razumijem — nie rozumiem. O powtórzenie poprosisz: Možeš li ponoviti? albo krótko Još jednom, molim. Gdy ktoś mówi za szybko: Polako, molim. Gdy brakuje ci słowa: Kako se to kaže na hrvatskom?",
        "examples": [
          {
            "target": "Ne razumijem.",
            "source": "Nie rozumiem.",
          ...
          {
            "target": "Možeš li ponoviti, molim?",
            "source": "Czy możesz powtórzyć, proszę?",
            "audioSrc": "/audio/hr/a1/module-01/mozes-li-ponoviti-molim.mp3"
          },
          {
            "target": "Polako, molim.",
      ...
      },
      {
        ...
        "stage": "practice",
        "type": "choice",
        "instruction": "Co powiesz?",
        "prompt": "Ana mówi bardzo szybko. Poproś, żeby mówiła wolniej.",
        "options": [
          "Polako, molim.",
          "Doviđenja!",
          "Dobro sam, hvala."
      ...
      },
      {
        ...
        "answerAudioSrc": "/audio/hr/a1/module-08/ne-razumijem.mp3"
      },
      {
        "id": "dialog",
        "stage": "dialog",
  ...
  material: {
    ...
    "records": [
      ...
      },
      {
        ...
        "pl": "Jak to się mówi po chorwacku?",
        "lemma": "",
        "partOfSpeech": "",
        "exerciseType": "translation|word_order|listening|gap",
        "acceptedAnswers": [
