...
export const LESSON: GeneratedLesson = {
  content: {
    ...
    "vocabulary": [
      {
        "target": "hoću",
        "source": "chcę; tak (odpowiedź na Hoćeš li…?)",
        "lemma": "htjeti",
    ...
    "steps": [
      ...
      },
      {
        ...
        "correctIndex": 2,
        "targetText": "options",
        "answerAudioSrc": "/audio/hr/a1/module-08/sljedeci-tjedan.mp3"
      },
      {
        "id": "word-7",
        "stage": "words",
      ...
      },
      {
        ...
        "options": [
          "wkrótce",
          "będziecie (partykuła futurum)",
          "mieć nadzieję"
        ],
        "correctIndex": 1,
        "targetText": "prompt",
        "promptAudioSrc": "/audio/hr/a1/module-08/cete.mp3"
      },
      {
        "id": "examples",
        "stage": "words",
      ...
      },
      {
        ...
        "explanation": "O przyszłości mówisz ću (ja) albo ćeš (ty) + bezokolicznik: Sutra ću raditi — jutro będę pracować. Ću nie otwiera zdania: Sutra ću učiti, Kasnije ću se odmoriti. Pytanie zaczynasz od Hoćeš li…? — Hoćeš li ići sa mnom? Na takie pytanie odpowiadasz krótko: Hoću! — tak (chcę, pójdę). Plany zapowiesz też słowem planirati: Planiram ići na more.",
        "examples": [
          {
            "target": "Sutra ću raditi.",
            "source": "Jutro będę pracować.",
  ...
  material: {
    ...
    "records": [
      ...
      },
      {
        ...
        "sequence": 1,
        "hr": "hoću",
        "pl": "chcę; tak (odpowiedź na Hoćeš li…?)",
        "lemma": "htjeti",
        "partOfSpeech": "verb_form",
      ...
      },
      {
        ...
        "type": "sentence",
        "sequence": 11,
        "hr": "Hoćeš li ići na more? — Hoću!",
        "pl": "Pojedziesz nad morze? — Tak!",
        "lemma": "",
        "partOfSpeech": "",
        "exerciseType": "listening|comprehension",
        "acceptedAnswers": [
          "Hoćeš li ići na more? — Hoću!"
        ],
      ...
      },
      {
        ...
        "type": "sentence",
        "sequence": 12,
        "hr": "Planiram ići na more.",
        "pl": "Planuję pojechać nad morze.",
        "lemma": "",
        "partOfSpeech": "",
        "exerciseType": "listening|comprehension",
        "acceptedAnswers": [
          "Planiram ići na more."
        ],
        "notes": "Zdanie przykładowe (Etap 2 po audycie A1); pokazywane z nagraniem w kroku „Nowe słowa w zdaniach”.",
        "tags": [
          "sentence",
      ...
      },
      {
        ...
        "type": "sentence",
        "sequence": 13,
        "hr": "Što ćeš raditi u subotu?",
        "pl": "Co będziesz robić w sobotę?",
        "lemma": "",
        "partOfSpeech": "",
        "exerciseType": "listening|comprehension",
        "acceptedAnswers": [
