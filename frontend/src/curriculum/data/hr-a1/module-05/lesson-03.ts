  ...
  content: {
    ...
    "steps": [
      ...
      },
      {
        ...
        "explanation": "Wskazówki usłyszysz jako grzeczne prośby: Idite — proszę iść, Skrenite — proszę skręcić, Prijeđite — proszę przejść. Nie musisz ich odmieniać — zapamiętaj je jako gotowe zwroty razem z ravno, lijevo i desno. O drogę zapytasz: Kako mogu doći do…? — jak mogę dojść do…?",
        "examples": [
          {
            "target": "Idite ravno.",
            "source": "Proszę iść prosto.",
  ...
  material: {
    ...
    "records": [
      ...
      },
      {
        ...
        "type": "sentence",
        "sequence": 11,
        "hr": "Kako mogu doći do kolodvora?",
        "pl": "Jak mogę dojść do dworca?",
        "lemma": "",
        "partOfSpeech": "",
        "exerciseType": "translation|word_order|listening|gap",
        "acceptedAnswers": [
